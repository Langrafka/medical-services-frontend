    ...
    <section className="flex flex-col items-center text-center px-5">
      <div className="relative mb-8">
        ...
        <a
          ...
          className="absolute top-4 -right-[103px] w-[72px] h-[72px] rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 active:scale-95 cursor-pointer"
      ...
      <div className="flex flex-col gap-5 text-main-dark text-[16px] leading-[1.5] tracking-[-0.02em] font-normal">
        <p>
